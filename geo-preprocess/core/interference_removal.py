...
# ─────────────────────────────────────────────
# 指数计算 — 统一从 commons 共享层引入(单一事实来源,与 geo-analyser 共用)
# ─────────────────────────────────────────────
...
from commons.spectral_indices import (
    _safe_divide, calc_ndvi, calc_ndwi, calc_mndwi, calc_ndbi, calc_bsi,
    calc_ndre, calc_cire, calc_rep,
)
